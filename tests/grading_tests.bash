...
#sectorsize and imagesize increased because 'sync' was having trouble.
for SectorSize in "4" "8" "16" "32" "64"
do
    for ImageSize in "230400" "262144" "524288" "1M" "5M" "10M" "20M" "50M" "100M"
    do
        ...
        do
            ...
            cp -r examples/mmap.c examples/fread.c src/extfat.c src/extractFile.c common/routines.c /tmp/d
